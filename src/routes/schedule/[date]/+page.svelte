...
<div class="h-full min-h-screen p-4">
	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-xl lg:text-2xl">
		{#each allGames as game}
			<a
				href="/{game.gamePk}"
				class="hover:transform hover:scale-[1.01] transition-all duration-100 ease-in"
			>
							...
							{:then { numOuts, batterCount, inningState, inning, bases }}
								<div class="flex flex-col items-center gap-2">
									...
									<div class="w-10 h-7 relative">
										<div
											id="first"
											class={bases.includes('first') ? 'diamond-filled' : 'diamond'}
										/>
										<div
											id="second"
										...
										<div
											id="third"
											class={bases.includes('third') ? 'diamond-filled' : 'diamond'}
										/>
									</div>
									<!-- <p>Outs: {numOuts}</p> -->
